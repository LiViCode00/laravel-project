    ...
    public function run()
    {
        ...
        $courses = [
            [   
                ...
                "image_path" => 'img/courses/html.png',
                "price" => '1000000',
                "sale_price" => '899000',
            ...
            [   
                ...
                "image_path" => 'img/courses/javascript.jpg',
                "price" => '1700000',
                "sale_price" => '0',
                "teacher_id" => $teachers->random()->id,
                "category_id" => $categories->random()->id
            ...
            [    
                ...
                "image_path" => 'img/courses/nodejs.jpg',
                "price" => '2000000',
                "sale_price" => '1200000',
                "teacher_id" => $teachers->random()->id,
                "category_id" => $categories->random()->id
            ...
            [    
                ...
                "image_path" => 'img/courses/reactjs.png',
                "price" => '0',
                "sale_price" => '0',
                "teacher_id" => $teachers->random()->id,
                "category_id" => $categories->random()->id
