                                ...
                                <td data-th="Product">
                                    <div class="row my-4">
                                        <div class="checkbox-wrapper-31">
                                            ...
                                            <input type="checkbox" name="courses[]" class="course-checkbox" id="course_{{ $course->id }}"
                                                data-price="{{ $course->sale_price }}" value="{{ $course->id }}">
                                        ...
                                        <div class="col-sm-3 hidden-xs d-flex justify-content-center align-items-center">
                                            <img style="border-radius: 8px;" src="/{{ $course->image_path }}"
