                ...
                <div class="row">
                    <div class="col-lg-5">
                        ...
                        <div class="teachers-cont">
                            <p>LiviCode có đội giảng viên chất lượng, kiến thức sâu rộng và kinh nghiệm thực tế trong công nghệ, cung cấp sự hỗ trợ và động viên mạnh mẽ cho học viên trong hành trình khám phá lập trình. <br> <br> Chúng
                            ...
                            <a style="margin-top: 60px; font-size: 15px;" href="#" class="main-btn mt-55 pt-2 pb-2">Bắt đầu dạy học ngay hôm
                                nay</a>
                        </div> <!-- teachers cont -->
                    </div>
