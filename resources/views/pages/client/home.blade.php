                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="singel-course">
                            ...
                            <div class="cont">
                                ...
                                <div class="course-teacher">
                                    <div class="thum">
                                        <a href="#"><img src="{{ asset('client/images/course/teacher/t-3.jpg') }}"
                                                alt="teacher"></a>
                                    </div>
                                    <div class="name">
                                        <a href="#">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="singel-course">
                            ...
                            <div class="cont">
                                ...
                                <div class="course-teacher">
                                    <div class="thum">
                                        <a href="#"><img src="{{ asset('client/images/course/teacher/t-4.jpg') }}"
                                                alt="teacher"></a>
                                    </div>
                                    <div class="name">
                                        <a href="#">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="singel-course">
                            ...
                            <div class="cont">
                                ...
                                <div class="course-teacher">
                                    <div class="thum">
                                        <a href="#"><img src="{{ asset('client/images/course/teacher/t-5.jpg') }}"
                                                alt="teacher"></a>
                                    </div>
                                    <div class="name">
                                        <a href="#">
                ...
                <div class="row">
                    <div class="col-lg-5">
                        ...
                        <div class="teachers-cont">
                            <p>Giảng viên tại LiviCode là những chuyên gia hàng đầu trong ngành công nghiệp công nghệ. Với
                                nền tảng kiến thức sâu rộng và nhiều năm kinh nghiệm thực tế, họ đem đến cho học viên sự
                                hướng dẫn chân thành và động lực mạnh mẽ để khám phá thế giới mã nguồn mở. <br> <br> Chúng
                                tôi tự hào có đội ngũ giảng viên xuất sắc, luôn cống hiến hết mình để hỗ trợ sự phát triển
                                của cộng đồng học viên trong hành trình khám phá lập trình.</p>
                            <br>
                            <br>
                            <h4>Bạn muốn trở thành giảng viên tại LiViCode?</h4>
                            <a style="margin-top: 60px" href="#" class="main-btn mt-55">Bắt đầu dạy học ngay hôm
                                nay</a>
                        </div> <!-- teachers cont -->
                    </div>
